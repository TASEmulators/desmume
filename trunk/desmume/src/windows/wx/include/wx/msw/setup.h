...
#define wxUSE_ON_FATAL_EXCEPTION 0 //zero 10-dec-2009
...
#define wxUSE_STACKWALKER 0 //zero 10-dec-2009
...
#define wxUSE_DEBUGREPORT 0 //zero 10-dec-2009
...
// Recommended setting: 1
#define wxUSE_LOGWINDOW 0 //zero 10-dec-2009

// Recommended setting: 1
#define wxUSE_LOGGUI 0 //zero 10-dec-2009

// Recommended setting: 1
#define wxUSE_LOG_DIALOG 0 //zero 10-dec-2009
...
#define wxUSE_CMDLINE_PARSER 0 //zero 10-dec-2009
...
#define wxUSE_THREADS 0 //zero 10-dec-2009
...
#define wxUSE_STREAMS       0 //zero 10-dec-2009
...
//                      problem
#define wxUSE_STD_IOSTREAM  1 //zero 10-dec-2009
...
#define wxUSE_PRINTF_POS_PARAMS      0 //zero 10-dec-2009
...
#define wxUSE_INTL          0 //zero 10-dec-2009
...
//
// Recommended setting: 1
#define wxUSE_CONFIG        0 //zero 10-dec-2009 (might want this though)
...
//
// Recommended setting: 1
#define wxUSE_CONFIG_NATIVE   0 //zero 10-dec-2009
...
//
// Recommended setting: 1
#define wxUSE_DIALUP_MANAGER   0 //zero 10-dec-2009
...
//
// Recommended setting: 1
#define wxUSE_DYNLIB_CLASS    1 //zero 10-dec-2009 - I would like to disable it, but 64bit windows detection needs it

// experimental, don't use for now
#define wxUSE_DYNAMIC_LOADER  1 //zero 10-dec-2009

// Set to 1 to use socket classes
#define wxUSE_SOCKETS       0 //zero 10-dec-2009

// Set to 1 to enable virtual file systems (required by wxHTML)
#define wxUSE_FILESYSTEM    0 //zero 10-dec-2009

// Set to 1 to enable virtual ZIP filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_ZIP        0 //zero 10-dec-2009

// Set to 1 to enable virtual archive filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_ARCHIVE    0 //zero 10-dec-2009

// Set to 1 to enable virtual Internet filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_INET       0 //zero 10-dec-2009

// wxArchive classes for accessing archives such as zip and tar
#define wxUSE_ARCHIVE_STREAMS     0 //zero 10-dec-2009

// Set to 1 to compile wxZipInput/OutputStream classes.
#define wxUSE_ZIPSTREAM     0 //zero 10-dec-2009

// Set to 1 to compile wxTarInput/OutputStream classes.
#define wxUSE_TARSTREAM     0 //zero 10-dec-2009

// Set to 1 to compile wxZlibInput/OutputStream classes. Also required by
// wxUSE_LIBPNG
#define wxUSE_ZLIB          0 //zero 10-dec-2009
...
#define wxUSE_APPLE_IEEE          0 //zero 10-dec-2009

// Joystick support class
#define wxUSE_JOYSTICK            0 //zero 10-dec-2009

// wxFontMapper class
#define wxUSE_FONTMAP 1 //zero 10-dec-2009

// wxMimeTypesManager class
#define wxUSE_MIMETYPE 0 //zero 10-dec-2009
...
//
// Recommended setting: 1
#define wxUSE_PROTOCOL 0 //zero 10-dec-2009

// The settings for the individual URL schemes
#define wxUSE_PROTOCOL_FILE 0 //zero 10-dec-2009
#define wxUSE_PROTOCOL_FTP 0 //zero 10-dec-2009
#define wxUSE_PROTOCOL_HTTP 0 //zero 10-dec-2009

// Define this to use wxURL class.
#define wxUSE_URL 0 //zero 10-dec-2009
...
#define wxUSE_VARIANT 0 //zero 10-dec-2009
...
#define wxUSE_REGEX       0 //zero 10-dec-2009

// wxSystemOptions class
#define wxUSE_SYSTEM_OPTIONS 1

// wxSound class
#define wxUSE_SOUND      0 //zero 10-dec-2009
...
//
// Recommended setting: 1
#define wxUSE_MEDIACTRL     0 //zero 10-dec-2009
...
#define wxUSE_DATAVIEWCTRL  0   // wxDataViewCtrl //zero 10-dec-2009
...
#define wxUSE_HOTKEY 0 //zero 10-dec-2009
...
#define wxUSE_DISPLAY       0 //zero 10-dec-2009
...
// splash screen class
#define wxUSE_SPLASH 0 //zero 10-dec-2009
...
//                      use this function
#define wxUSE_ABOUTDLG 0 //zero 10-dec-2009
...
#define wxUSE_METAFILE              0 //zero 10-dec-2009
#define wxUSE_ENH_METAFILE          0 //zero 10-dec-2009
...
#define wxUSE_PRINTING_ARCHITECTURE  0 //zero 10-dec-2009
...
// smaller library.
#define wxUSE_HTML          0 //zero 10-dec-2009
...
#define wxUSE_IPC         0 //zero 10-dec-2009
                                // 0 for no interprocess comms
#define wxUSE_HELP        0 //zero 10-dec-2009
...
#define wxUSE_MS_HTML_HELP 0 //zero 10-dec-2009


// Use wxHTML-based help controller?
#define wxUSE_WXHTML_HELP 0 //zero 10-dec-2009
...
#define wxUSE_IMAGE         1 //zero 10-dec-2009

// Set to 1 for PNG format support (requires libpng). Also requires wxUSE_ZLIB.
#define wxUSE_LIBPNG        0 //zero 10-dec-2009

// Set to 1 for JPEG format support (requires libjpeg)
#define wxUSE_LIBJPEG       0 //zero 10-dec-2009

// Set to 1 for TIFF format support (requires libtiff)
#define wxUSE_LIBTIFF       0 //zero 10-dec-2009

// Set to 1 for TGA format support (loading only)
#define wxUSE_TGA           0 //zero 10-dec-2009

// Set to 1 for GIF format support
#define wxUSE_GIF           0 //zero 10-dec-2009

// Set to 1 for PNM format support
#define wxUSE_PNM           0 //zero 10-dec-2009

// Set to 1 for PCX format support
#define wxUSE_PCX           0 //zero 10-dec-2009

// Set to 1 for IFF format support (Amiga format)
#define wxUSE_IFF           0

// Set to 1 for XPM format support
#define wxUSE_XPM           0 //zero 10-dec-2009

// Set to 1 for MS Icons and Cursors format support
#define wxUSE_ICO_CUR       1

// Set to 1 to compile in wxPalette class
#define wxUSE_PALETTE       0 //zero 10-dec-2009
...
#define wxUSE_UXTHEME           0 //zero 10-dec-2009

// Set to 1 to auto-adapt to MS Windows XP themes where possible
// (notably, wxNotebook pages)
#define wxUSE_UXTHEME_AUTO      0 //zero 10-dec-2009
...
//
// Recommended setting: 1, set to 0 if your programs never crash
#define wxUSE_CRASHREPORT 0 //zero 10-dec-2009
