...
# ADD CPP /nologo /MD /W3 /O2 /I "src/vio2sf/desmume" /I "src/vio2sf/zlib" /I "." /D "LSB_FIRST" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "AOSSFDRV_EXPORTS" /D "XSFDRIVER_EXTENDPARAM1NAME" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "src/vio2sf/desmume" /I "src/vio2sf/zlib" /I "." /D "LSB_FIRST" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "AOSSFDRV_EXPORTS" /D "XSFDRIVER_EXTENDPARAM1NAME" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"vio2sf.bin" /pdbtype:sept
