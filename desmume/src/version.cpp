...
const u8 DESMUME_VERSION_BUILD = 13;

#define DESMUME_VERSION_NUMERIC 91300
#define DESMUME_VERSION_STRING " " "0.9.13" DESMUME_SUBVERSION_STRING DESMUME_FEATURE_STRING DESMUME_PLATFORM_STRING DESMUME_JIT DESMUME_CPUEXT_STRING
