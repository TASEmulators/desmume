...
#else
	chan->sampinc = (((double)33554432) / (44100 * 2)) / (double)(0x10000 - chan->timer);
#endif
}
...
#else
static const double time_per_frame = (double)1.0/(double)59.8261; // ((double)ARM7_CLOCK/6/355/263)
#endif
