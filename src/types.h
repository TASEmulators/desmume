...
#else
#define DESMUME_SUBVERSION_STRING " WIP" // " svn"
#endif
...
#define DESMUME_VERSION_STRING " " "0.9.2+" DESMUME_SUBVERSION_STRING DESMUME_FEATURE_STRING DESMUME_PLATFORM_STRING DESMUME_CPUEXT_STRING DESMUME_COMPILER
