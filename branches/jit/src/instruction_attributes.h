...
// Which registers are used as inputs.
// This describes the jit implementation, not the theoretical behavior of ARM:
// If an instruction depends on the value of R15 but doesn't need it to be stored in armcpu_t::R[15], then it won't have a SRCREG_R15 flag.
