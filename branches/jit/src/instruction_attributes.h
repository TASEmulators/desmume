...
// SRCREG_R15 and SRCREG_NEXTINST are ignored: R15 and nextinst are always known at recompile-time,
// so instructions that use them don't actually introduce any dependencies in the compiled code.
#define SRCREG_R15      0x0200
#define SRCREG_NEXTINST 0x0400
