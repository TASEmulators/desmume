...
// NOTE: DEFINING G_NEW_SPU_TIMING CHANGES THE MOVIE SYNC
//#ifndef G_NEW_SPU_TIMING
//#define G_NEW_SPU_TIMING
//#endif
...
int NDS_LoadROM(const char *filename, int bmtype, u32 bmsize, const char* logicalFilename=0);
#else
int NDS_LoadROM(const char *filename, int bmtype, u32 bmsize,
                 const char *cflash_disk_image_file, const char* logicalFilename=0);
#endif
